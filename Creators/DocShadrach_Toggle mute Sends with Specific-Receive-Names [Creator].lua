...
local script_name
if track_name == "" then
    script_name = "[Generated]_Toggle mute Sends " .. table.concat(send_names, "-") .. " SelectedTrack.lua"
else
    script_name = "[Generated]_Toggle mute Sends " .. table.concat(send_names, "-") .. " " .. track_name .. ".lua"
end
