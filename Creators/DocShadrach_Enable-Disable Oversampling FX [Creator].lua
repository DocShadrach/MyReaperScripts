...
local script_name_enable = "[Generated]_Enable Oversampling " .. oversampling .. "x " .. fxName .. " " .. trackName
local script_name_disable = "[Generated]_Disable Oversampling " .. fxName .. " " .. trackName

-- Add the position to the names if it's not 0
if fxPosition ~= 0 then
    script_name_enable = script_name_enable .. " " .. fxPosition .. " position"
    script_name_disable = script_name_disable .. " " .. fxPosition .. " position"
end
