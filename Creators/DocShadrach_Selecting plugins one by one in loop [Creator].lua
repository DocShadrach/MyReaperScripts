...
if apply_to_all_plugins then
    script_name = "[Generated]_Selecting all plugins one by one in loop " .. track_name
    if fx_container > 0 then
        script_name = script_name .. " " .. fx_container .. "Container"
    end
    script_name = script_name .. ".lua"
else
    script_name = "[Generated]_Selecting plugins in range(" .. (min_fx + 1) .. "-" .. (max_fx + 1) .. ") one by one in loop " .. track_name
    if fx_container > 0 then
        script_name = script_name .. " " .. fx_container .. "Container"
    end
    script_name = script_name .. ".lua"
